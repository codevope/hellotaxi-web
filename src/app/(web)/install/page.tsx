  ...
  const features = [
    {
      ...
      description: "Inicia la app directamente desde tu pantalla de inicio, sin necesidad de abrir el navegador"
    },
    {
      icon: Bell,
      title: "Notificaciones push",
      description: "Recibe alertas en tiempo real sobre el estado de tu viaje y mensajes del conductor"
    },
    {
      icon: Wifi,
      title: "Funciona sin conexión",
      description: "Accede a funciones básicas y tu historial de viajes incluso sin conexión a internet"
    },
    {
      icon: Battery,
      title: "Optimizada para móvil",
      description: "Diseño nativo que consume menos batería y funciona más rápido que en el navegador"
    }
  ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2E4CA6] via-[#0477BF] to-[#049DD9] flex items-center justify-center p-4">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-4">¡Ya tienes HelloTaxi instalado! 🎉</h1>
          <p className="text-lg text-white/90 mb-8">
            Estás usando la versión de app instalada. Disfruta de la mejor experiencia.
          </p>
          <Link href="/">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2E4CA6] via-[#0477BF] to-[#049DD9]">
        ...
        <div className="relative px-4 py-16 sm:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.h1 
              ...
              {...fadeInUp}
            >
              Instala <span className="bg-gradient-to-r from-yellow-200 to-yellow-400 bg-clip-text text-transparent">HelloTaxi</span>
            </motion.h1>
            ...
            >
              Obtén la mejor experiencia con nuestra app nativa. Más rápida, más confiable y siempre a tu alcance.
            </motion.p>
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="bg-white/10 backdrop-blur-lg border-white/20 text-white h-full hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  <CardContent className="p-6 text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-yellow-300 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          {!isIOS && !isAndroid && (
            <motion.div variants={fadeInUp}>
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-4">💻 Navegador de Escritorio</h3>
                <p className="text-white/80 mb-6">
                  Busca el botón "Instalar" en la barra de direcciones de tu navegador o usa Ctrl+Shift+I.
                </p>
                {isInstallable && (
                  <Button 
                    onClick={handleInstallClick}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Únete a miles de usuarios que ya disfrutan de HelloTaxi como app nativa.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/about">
              <Button 
                variant="outline" 
                className="border-white text-white hover:bg-white hover:text-[#2E4CA6] text-lg font-bold px-8 py-4 rounded-full"
              >
                Más Información
              </Button>
            </Link>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 -left-1/4 w-96 h-96 bg-gradient-to-br from-yellow-300/20 to-transparent rounded-full blur-3xl"></div>

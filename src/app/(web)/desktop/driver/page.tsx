              ...
              {(activeRideHook || completedRideForRating) && (
                <>
                  ...
                  <Button
                    ...
                    className="absolute bottom-4 left-4 h-12 w-auto px-4 bg-white/95 backdrop-blur-sm border border-gray-200 shadow-lg hover:bg-white/100 text-gray-900 rounded-lg"
                  >
                    {completedRideForRating ? (
                      <>
                  ...
                  >
                    <SheetContent 
                      side="left" 
                      className="w-[400px] p-0 rounded-r-2xl"
                    >
              ...
              <CardContent className="p-0">
                ...
                >
                  ...
                  <TabsContent value="config" className="mt-0 p-0">
                    <div className="p-6 h-[calc(100vh-300px)] overflow-y-auto space-y-4">
